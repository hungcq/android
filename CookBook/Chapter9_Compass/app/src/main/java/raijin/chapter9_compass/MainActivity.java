package raijin.chapter9_compass;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        mSensorManager.registerListener(mSensorListener, mMagnetometer, SensorManager.SENSOR_DELAY_GAME);
    ...
    private void calculateCompassDirection(SensorEvent event) {
        ...
        boolean success = SensorManager.getRotationMatrix(
                mRotationMatrix, null, mAccelerationValues, mGravityValues);
        if (success) {
