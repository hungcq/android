...
import com.online.foodplus.adapters.ListNormalAdapter;
...
public class ListNormalView extends LinearLayout {
    private RecyclerView rvContent;
    private ArrayList<Base> datas;
    private ListNormalAdapter adapter;

    public ListNormalView(Context context) {
        super(context);
        init(context, null);
    }

    public ListNormalView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        if (inflater != null) {
            ...
            rvContent.addItemDecoration(new GridSpacingItemDecoration(1, (int) context.getResources().getDimension(R.dimen._4sdp), false));
