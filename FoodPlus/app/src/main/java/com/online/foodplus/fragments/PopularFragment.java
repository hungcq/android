...
public class PopularFragment extends Fragment {
    ...
    private void getData() {
        if (!isSending && isMoreDataAvailable) {
           ...
           // System.out.println("------------------------POPULAR REQUEST " + getResources().getString(R.string.api_mapsrv) + "?" + params.toString());
            Tool.get(getResources().getString(R.string.api_mapsrv), params, new JsonHttpResponseHandler() {
                @Override
                public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
                    //System.out.println("------------------------POPULAR RESPONSE " + getResources().getString(R.string.api_mapsrv) + "?" + params.toString());
