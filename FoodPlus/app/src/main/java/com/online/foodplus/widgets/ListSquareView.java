...
import com.online.foodplus.adapters.ListSquareAdapter;
...
public class ListSquareView extends LinearLayout {
    private RecyclerView rvContent;
    private ArrayList<Base> datas;
    private ListSquareAdapter adapter;

    public ListSquareView(Context context) {
        super(context);
        init(context, null);
    }

    public ListSquareView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        if (inflater != null) {
            ...
            datas = new ArrayList<>();
            adapter = new ListSquareAdapter(this.datas, true);
