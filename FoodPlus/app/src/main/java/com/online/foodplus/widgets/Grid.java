...
public class Grid extends LinearLayout {
    ...
    public void setData(List<Base> datas) {
        if (datas != null && rvContent != null) {
            this.datas.clear();
    ...
    public void enableEdge(boolean status) {
        rvContent.addItemDecoration(new GridSpacingItemDecoration(2, 12, status));
    }
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        if (inflater != null) {
            ...
            rvContent.addItemDecoration(new GridSpacingItemDecoration(2, (int) context.getResources().getDimension(R.dimen._4sdp), false));
