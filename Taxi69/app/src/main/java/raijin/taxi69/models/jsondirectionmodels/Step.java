...
package raijin.taxi69.models.jsondirectionmodels;
...
public class Step {
    ...
    @Expose
    private JsonPolylineModel polyline;
    ...
    public JsonPolylineModel getPolyline() {
        return polyline;
    }

    public void setPolyline(JsonPolylineModel jsonPolylineModel) {
        this.polyline = jsonPolylineModel;
    }
